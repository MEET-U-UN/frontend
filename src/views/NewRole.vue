        ...
        <div class="row">
            <div class="col-12 col-sm-10 col-md-8 offset-sm-1 offset-md-2">
                <div id="signUp" class="mt-5">
                    ...
                    <form class="border border-primary rounded form-inline" @submit="addRole">

                        <h2 class="col-12 text-center text-primary mt-3 mb-5">Nuevo Rol</h2>
            ...
            addRole( event ){
                axios
                    ...
                    if( response.status !== 201 ){
                        alert( "Error en el adicionar nuevo rol" )
                    }else{
                        alert( "Nuevo rol Agregado Correctamente" )
                    }
                }).catch( error =>{
                    if( error.response.status === 400 ){
                        alert( "Parece que ya tiene asignado el rol solicitado " );
                    }else{
